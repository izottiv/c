...
//tipo assim acho que esse é o codigo mais bem 
//estruturado do ziviani no sentido de entender ele, 
//adicionei uns print so pra ter certeza mas né n tem mt oq fzr 
//inclusive foi mal a informalidade de modo geral 👍


//Continuando agora pra remoção
...
{  *Dicionario = NULL; 
printf("iniciou a arvore, ta vazia\n");}
...
void InsereNaPagina(TipoApontador Ap, TipoRegistro Reg, TipoApontador ApDir) {
  ...
  Ap->p[k + 1] = ApDir;
  Ap->n++;
  printf("inseriu o %ld o total de valores na pag e %d\n", Reg.Chave, Ap->n);
}
...
{ long i = 1; long j;
  ...
  printf("tem que dividir a pag ta cheio\n");
...
{ long j, Ind = 1;
  ...
  { 
    ...
    printf("trocando com antecessor\n");
    Antecessor(*Ap, Ind, Pag->p[Ind-1], Diminuiu);
    if (*Diminuiu) 
    printf("reconstituindo depois de tirar o antecessor\n");
