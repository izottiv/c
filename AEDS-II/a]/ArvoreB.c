...
//Função de inicializar o Dicionario
...
short NaoAchouPosicao;
  ...
  Ap->n++;
   ...
   printf("Pagina tem %d elementos\n", Ap->n);
} 

//Função que verifica onde deve inserir
void Ins(TipoRegistro Reg, TipoApontador Ap, short *Cresceu, TipoRegistro *RegRetorno,  TipoApontador *ApRetorno){ 
  ...
  *Cresceu = TRUE; (*RegRetorno) = Reg; (*ApRetorno) = NULL;
   ...
   printf("Inserindo o valor %ld na pagina com %d elementos\n", Reg.Chave, Ap->n);
  ...
  printf("Precisou dividir a pagina por causa do %d\n", RegRetorno->Chave);
  ...
  *RegRetorno = Ap->r[M];  *ApRetorno = ApTemp;
  printf("O valor %d foi pra cima\n", RegRetorno->Chave);
}

//Função Insere par ao usuario
...
//Função que repara a arvore se precisar
...
//Função de encontrar o Antecessor 
...
//Função de Retirar para o usuario
...
//Função de Imprimir para usuario
...
//Função para testar a arvore usuario
